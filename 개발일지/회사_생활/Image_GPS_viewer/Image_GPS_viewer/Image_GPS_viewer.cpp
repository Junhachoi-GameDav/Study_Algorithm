...
// Image_GPS_viewer.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
// CImageGPSviewerApp 생성

CImageGPSviewerApp::CImageGPSviewerApp() noexcept
{
	...
	SetAppID(_T("ImageGPSviewer.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CImageGPSviewerApp 개체입니다.

CImageGPSviewerApp theApp;


// CImageGPSviewerApp 초기화

BOOL CImageGPSviewerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_ImageGPSviewerTYPE,
		RUNTIME_CLASS(CImageGPSviewerDoc),
		RUNTIME_CLASS(CChildFrame), // 사용자 지정 MDI 자식 프레임입니다.
		RUNTIME_CLASS(CImageGPSviewerView));
	if (!pDocTemplate)
		return FALSE;
...
int CImageGPSviewerApp::ExitInstance()
{
...
void CImageGPSviewerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CImageGPSviewerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CImageGPSviewerApp::LoadCustomState()
{
}

void CImageGPSviewerApp::SaveCustomState()
{
}
