...
public class Self0801 extends AppCompatActivity {
    ...
    DatePicker dp;
    EditText edtDiary;
    Button btnWrite, btnOpen, btnCancel;  //add
    String fileName;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnOpen = (Button) findViewById(R.id.btnOpen);  // add
        btnCancel = (Button) findViewById(R.id.btnCancel);  //add
        ...
        String str = readDiary2(fileName);    //  add
...
//  add
    ...
    String readDiary(String fName) {
        ...
        try {
            ...
            btnWrite.setVisibility(View.VISIBLE);   // add
