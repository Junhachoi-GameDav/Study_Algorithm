...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
                     ...
                     _In_ int       nCmdShow)
{
    //UNREFERENCED_PARAMETER(hPrevInstance); //남겨도되고 큰지장은 없다
    //UNREFERENCED_PARAMETER(lpCmdLine);     //남겨도되고 큰지장은 없다
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = nullptr; //MAKEINTRESOURCEW(IDC_GAMECODING);  //사용안할거는 nullptr로 밀어도 됨.
